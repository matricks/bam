...
# the actual compile
echo "compiling using $CC as host compiler and i686-w64-mingw32-gcc as target compiler..." >&2
...
i686-w64-mingw32-gcc -Wall -DLUA_BUILD_AS_DLL -pedantic src/*.c src/lua/*.c -o bam -I src/lua -lm -lpthread -O2 $*
